class Config:
    ...
    def get_default_config(args):
        ...
        config.SUBTOKENS_VOCAB_MAX_SIZE = 150
        config.TARGET_VOCAB_MAX_SIZE = 100
        config.EMBEDDINGS_SIZE = 16
        config.RNN_SIZE = 16 * 2
        ...
        config.EMBEDDINGS_DROPOUT_KEEP_PROB = 1 #0.75
        config.RNN_DROPOUT_KEEP_PROB = 1 #0.5
        config.BIRNN = True
